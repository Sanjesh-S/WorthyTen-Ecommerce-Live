...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadPickupRequests() {
        ...
        try {
            ...
            snap.forEach(doc => {
                ...
                let statusCell = `<td>${statusBadge}</td>`;
    ...
    function setupPickupListeners() {
        pickupListBody.addEventListener('click', async (e) => {
            const btn = e.target;
            if (!btn.classList.contains('action-btn-sm')) return;
            ...
            // Suspect Button
                ...
                if (!confirm("Are you sure you want to mark this as SUSPICIOUS?")) return;
            ...
            // Reopen Button
                ...
                if (!confirm("Reopen this request as 'New'?")) return;
