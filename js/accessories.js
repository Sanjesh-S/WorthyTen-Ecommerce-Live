...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (evaluationImage && vd.imageUrl) {
    evaluationImage.src = vd.imageUrl;
  }
  if (evaluationModel) {
  ...
  const selected = new Set(vd.accessories || []);
